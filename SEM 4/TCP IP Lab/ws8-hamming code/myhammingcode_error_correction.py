# -*- coding: utf-8 -*-
"""
Created on Fri Apr  1 15:13:42 2022
...
# print(hamming[1:4])
hamming_errorcode=int_hamming

hamming_errorcode[len(int_hamming)-1]=0

print("\nthis hamming code below is erraneous!!")

print_hamming_code(hamming_errorcode)

err_flag=0
err_rbits=list()

for i in rBits:
   if hamming_errorcode[int(i)-1]!= parity_check(int(i)):
        err_flag=1
        break
if(err_flag==0):
     ...
     for i in rBits:
        err_rbits.append(hamming_errorcode[int(i)-1])

err_rbits=list(reversed(err_rbits))        
print(err_rbits)